...
abstract class BLTextTheme {
  static const HEADER1 = TextStyle(fontFamily: 'Pretendard', fontWeight: FontWeight.bold, fontSize: 28, height: 1.2, color: BLColors.TEXT);
  static const HEADER2 = TextStyle(fontFamily: 'Pretendard', fontWeight: FontWeight.bold, fontSize: 22, height: 1.2, color: BLColors.TEXT);
